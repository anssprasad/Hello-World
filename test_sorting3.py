...
#Add a description at the begining of the script file. what this script does, what is the expected format of input and what is the expected 
#format of output. 
#Display or print only useful information to the terminal; like success; name of output file etc; names of the input files being processed
